...
```bash
wget -O bp_linux.tar.gz https://github.com/Azure/blobporter/releases/download/v0.5.03/bp_linux.tar.gz
...
Download [BlobPorter.exe](https://github.com/Azure/blobporter/releases/download/v0.5.03/bp_windows.zip)
